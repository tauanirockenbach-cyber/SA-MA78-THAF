...
def listar_usuario():
    ...
    try:
        ...
        SELECT
            ...
            status_usuario, telefone_usuario, data_nasc_usuario,
...
def criar_usuario(nome_usuario, email_usuario, senha, cargo_usuario, status_usuario,
                   telefone_usuario, data_nasc_usuario, id_setor, data_cadastro):
    conexao = None
    cursor = None
    try:
        conexao = conectar()
        ...
        """
        valores = (nome_usuario, email_usuario, senha, cargo_usuario, status_usuario,
                   telefone_usuario, data_nasc_usuario, id_setor, data_cadastro)
...
def opcao_desejada_usuario():
    ...
    while True:
        ...
        if opcao_usuario == 1:
            ...
            criar_usuario(nome, email, senha, cargo, status, telefone,
                          data_nasc, id_setor, data_cadastro)
