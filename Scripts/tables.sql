...
CREATE TABLE Usuarios (
    ...
    -- ENUM Corrigido para abraçar todos os perfis inseridos nos dados
...
CREATE TABLE Movimentacao_Ferramentas (
    ...
    id_entregador INT, 
    data_retirada TIMESTAMP NULL DEFAULT NULL, -- Alterado para aceitar registros agendados (sem data de retirada inicial)
